...
public class HTTPClientUtil {
  ...
  public static Map<String, String> httpGetWithResponseMap(String url,
      Map<String, String> headerParams, boolean... allowRedirects) {
    return httpGetWithResponseMap(url, headerParams, null, allowRedirects);
  }

  public static Map<String, String> httpPostWithResponseMap(String url, String params,
      Map<String, String> headerParams, boolean... allowRedirects) {
    return httpPostWithResponseMap(url, params, headerParams, null, allowRedirects);
  }

  public static Map<String, String> httpGetWithResponseMap(String url,
      Map<String, String> headerParams, String[] proxyParams, boolean... allowRedirects) {
    log.debug("httpGetWithResponseMap url=" + url);
    ...
    if (allowRedirects != null && allowRedirects.length > 0) {
      client = getHttpClient(allowRedirects[0], ssl, proxyParams);
    } else {
  ...
  public static Map<String, String> httpPostWithResponseMap(String url, String params,
      Map<String, String> headerParams, String[] proxyParams, boolean... allowRedirects) {
    log.debug("httpPostWithResponseMap url=" + url);
    Map<String, String> resultMap = new HashMap<String, String>();
    ...
    try {
      HttpEntity entity = new UrlEncodedFormEntity(paramPair, "UTF-8");
  ...
  private static DefaultHttpClient getHttpClient(boolean followRedirects, boolean ssl,
      String... proxy) {
