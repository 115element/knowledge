...
public class ReadablePropertySourcesPlaceholderConfigurer extends PropertySourcesPlaceholderConfigurer
        implements PropertiesWatcher.EventPublisher {

    protected static Logger log = LoggerFactory.getLogger(ReadablePropertySourcesPlaceholderConfigurer.class);

    private final PropertyChangedEventNotifier eventNotifier = new GuavaPropertyChangedEventNotifier();
    ...
    private Object buildResolvedString(final Object resolvedPropertyValue) {
        ...
        return new StringBuilder().append(resolvedValueStr.substring(0, startingIndex)).append(resolved)
