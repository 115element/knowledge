...
public class HTTPConnectionHelper {
	...
	public boolean downloadFile(String _url, Map<String, String> headerParams, String fileName, String... proxyParam) {
	...
	// --------------------------------------------------------
	private HttpURLConnection getHttpURLConnection(String _url, Map<String, String> headerParams,
			String... proxyParams) {
	...
	private Map<String, String> parseResponse(HttpURLConnection conn) {
