package com.example.bytecode_asm;
...
public class AsmTest {
    public static void main(String[] args) throws IOException {
        ...
        String className = "com/com.example.asm.AsmTest";
        ...
        File file = new File("D:\\DevelopmentSoftWare\\workstation\\knowledge\\asm\\src\\main\\resources\\AsmTest.class");
